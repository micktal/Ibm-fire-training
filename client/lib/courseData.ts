...
`,
    ...
    keyPoints: [
      ...
      "Les 3 réflexes dans l'ordre : Alarme (777) → Débrancher (si cela ne vous met pas en danger) → Évacuer",
  ...
  },
  {
    ...
    chapter: 1,
    number: 4,
    title: "CO2 ou eau pulvérisée ?",
    subtitle: "Choisir le bon extincteur",
    description:
      "En environnement IBM, deux extincteurs essentiels. CO2 pour tout feu électrique. Eau pulvérisée pour les solides (papier, plastique, mobilier).",
    objective: "Choisir le bon extincteur en deux secondes : CO2 ou eau.",
    learningObjectives: {
      savoir: "CO2 pour les feux électriques, eau pulvérisée pour les solides (papier, mobilier)",
      savoirFaire: "Identifier en 2 secondes si le feu est électrique ou non et choisir le bon agent",
    ...
    funFacts: [
      { stat: "CO₂", label: "seul agent sûr sur feu électrique", detail: "L'eau conduit l'électricité et provoque un risque d'électrocution fatal. Le CO2 étouffe la flamme sans conduire le courant et ne laisse pas de résidu sur les équipements.", icon: "alert" },
      { stat: "95%", label: "des feux de bureau : papier ou électrique", detail: "Knoître ces 2 situations vous prépare à la quasi-totalité des cas réels en entreprise. CO2 ou eau — pas besoin d'en savoir plus.", icon: "shield" },
    ],
    preTest: [
      {
        question: "Un feu électrique (câble, serveur) doit être éteint avec :",
        choices: [
          { key: "A", label: "De l'eau pulvérisée" },
          { key: "B", label: "Un extincteur CO2 uniquement" },
          { key: "C", label: "N'importe quel extincteur disponible" },
        ],
        correctKey: "B",
      },
      {
        question: "Une poubelle en papier prend feu. Aucun équipement électrique à proximité. Quel extincteur ?",
        choices: [
          { key: "A", label: "CO2" },
          { key: "B", label: "Eau pulvérisée" },
          { key: "C", label: "N'importe lequel" },
        ],
        correctKey: "B",
      },
    ],
    ...
    content: [
      ...
      {
        type: "list",
        title: "Les 2 situations à connaître en environnement IBM",
        body: "Dans vos bureaux, vous rencontrerez essentiellement deux types de feu :",
        bullets: [
          "Feu de solides (papier, plastique, mobilier, vêtement) → extincteur eau pulvérisée",
          "Feu électrique (serveur, câble, chargeur, imprimante sous tension) → CO2 uniquement — jamais d'eau",
          "Règle mémo : si c'électrique, c'est CO2. Si c'est du papier ou du plastique, c'est eau pulvérisée.",
        ],
        highlight: "Coupez toujours l'alimentation électrique avant d'intervenir si c'est possible.",
      },
      {
        type: "casefigure",
        ...
        cases: [
          ...
          {
            situation: "Chargeur de laptop qui chauffe et commence à fumer sur un bureau. L'agent attrape l'extincteur eau pulvérisée à proximité.",
            action: "Eau pulvérisée sur équipement électrique sous tension.",
            result: "Erreur critique. L'eau conduit l'électricité. Risque d'électrocution immédiat. CO2 obligatoire sur tout matériel IBM sous tension.",
            correct: false,
          },
        ],
      },
    ...
    keyPoints: [
      "Feu électrique (serveur, câble, imprimante) = CO2 uniquement. Jamais d'eau sur de l'électrique.",
      "Feu de solides (papier, plastique, mobilier) = eau pulvérisée. Efficace et sans danger sur ces matériaux.",
      "Règle simple : électrique → CO2. Papier/plastique → eau. Au moindre doute : n'intervenez pas, évacuez.",
    ],
    quiz: [
      {
        id: "q1",
        ...
        choices: [
          { key: "A", label: "Eau pulvérisée" },
          { key: "B", label: "CO2", hint: "Correct" },
          { key: "C", label: "N'importe quel extincteur disponible" },
          { key: "D", label: "Aucun — évacuer immédiatement" },
        ],
        correctKey: "B",
        feedbackOk: "Exact. Le CO2 est le seul agent sûr sur du matériel électrique sous tension. L'eau conduirait l'électricité.",
        feedbackKo: "Seul le CO2 est adapté aux feux électriques. L'eau conduit l'électricité — risque d'électrocution fatal.",
      },
    ],
    locked: true,
  },
  {
    ...
    learningObjectives: {
      ...
      savoirFaire: "Utiliser un extincteur CO2 ou eau pulvérisée de façon sécurisée à 2-3 mètres sur un feu naissant uniquement",
    ...
    content: [
      ...
      },
      {
        ...
        body: "Restez à 2-3 mètres du foyer — cette règle s'applique au CO2 comme à l'eau pulvérisée. Visez toujours la base des flammes. Maintenez une sortie dans votre dos pour pouvoir reculer rapidement si nécessaire. L'extincteur n'est jamais un outil de lutte contre un incendie déclaré : uniquement sur un feu naissant de très petite taille.",
    ...
    keyPoints: [
      "Extincteur = uniquement sur feu naissant de très petite taille (pas plus grand qu'une corbeille). Au moindre doute : évacuation.",
      "Distance : 2-3 mètres — que ce soit CO2 ou eau pulvérisée. Ne jamais s'approcher davantage.",
      "PASS : Pull (dégoupiller) · Aim (viser la base) · Squeeze (presser) · Sweep (balayer) — 4 étapes dans l'ordre.",
      "Si le feu ne recule pas après 30 secondes : reculez et évacuez immédiatement.",
    ],
    quiz: [
      {
        id: "q1",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        bullets: [
          "Tout début de feu naissant uniquement — pas plus grand qu'une corbeille à papier. Au moindre doute : évacuation.",
      ...
      },
      {
        ...
        cases: [
          {
            situation: "Poubelle en papier qui s'enflamme dans un bureau. Feu naissant, limité à la corbeille — très petit début de feu. CO2 disponible à 2-3 mètres. Sortie dans votre dos.",
            action: "Intervention avec le CO2. Séquence PASS, 2-3 mètres de distance, sortie libre.",
    ...
    keyPoints: [
      "L'extincteur = uniquement sur feu naissant de très petite taille (corbeille). Si le feu dépasse cette taille : n'intervenez pas — évacuez immédiatement.",
  ...
  },
  {
    ...
    learningObjectives: {
      ...
      savoirFaire: "Enchaîner les 3 réflexes : Alarme (777) → Débrancher (si cela ne vous met pas en danger) → Évacuer",
    ...
    preTest: [
      ...
      },
      {
        ...
        choices: [
          ...
          { key: "B", label: "Alarme (777) → Débrancher (si cela ne vous met pas en danger) → Évacuer" },
    ...
    content: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Le 777 n'est joignable que depuis un téléphone fixe IBM — pas depuis un mobile. En open space, les téléphones fixes ne sont pas toujours disponibles.",
          "Seul le site de Bois-Colombes dispose d'un poste de sécurité 24h/24. Sur les autres sites, la disponibilité varie.",
          "Séquence correcte : Boîtier rouge EN PREMIER — puis 777 si téléphone fixe disponible — puis le 18 si nécessaire.",
        ],
      },
      {
        type: "list",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "info",
        title: "EAS — Espaces d'Attente Sécurisés",
        body: "Les EAS sont des zones protégées, généralement situées sur les paliers d'escalier, prévues pour accueillir les personnes qui ne peuvent pas évacuer par les escaliers dans l'immédiat. Ce n'est pas un abandon — c'est une procédure réglementée.",
        bullets: [
        ...
        highlight: "Conduire une personne en EAS et l'y laisser ne signifie pas l'abandonner — les secours interviendront en priorité.",
      },
      {
        type: "info",
        title: "Incapacité temporaire à évacuer : qui est concerné ?",
        body: "Toute personne peut se retrouver temporairement dans l'incapacité d'évacuer par les escaliers dans des conditions normales. Ce n'est pas uniquement une question de handicap permanent.",
        bullets: [
          "Personne avec des béquilles ou un plâtre — descente des escaliers impossible ou dangereuse",
          "Personne avec une déficience visuelle temporaire ou permanente",
          "Salarié blessé pendant l'évacuation — chute, coupure, entorse",
          "Personne intoxiquée par la fumée — affaiblie, désorientée, incapable de descendre seule",
          "Femme enceinte en fin de grossesse — difficultés à se déplacer rapidement",
          "Visiteur âgé ou personne avec une condition médicale non déclarée",
        ],
        highlight: "En open space, identifiez avant tout incident qui pourrait avoir besoin d'aide — anticipation = protection.",
      },
      {
        type: "list",
    ...
    keyPoints: [
      "EAS (Espace d'Attente Sécurisé) : zone protégée sur palier d'escalier pour les personnes ne pouvant pas évacuer immédiatement.",
      "Incapacité temporaire : béquilles, intoxication fumée, blessure pendant l'évacuation, déficience visuelle — anticiper avant l'incident.",
      "Conduire en EAS puis signaler aux secours : c'est la procédure correcte, pas un abandon.",
    ],
    quiz: [
      {
        id: "q1",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "info",
        title: "EAS — Espaces d'Attente Sécurisés : fonctionnement",
        body: "L'EAS est une zone réglementaire, signalée par un panneau spécifique, généralement située sur le palier des escaliers de secours. Elle est conçue pour accueillir les personnes qui ne peuvent pas, à l'instant T, évacuer par les escaliers.",
        bullets: [
      ...
      {
        type: "info",
        title: "Qui doit utiliser un EAS ?",
        body: "L'incapacité à évacuer par les escaliers n'est pas uniquement liée à un handicap permanent. Elle peut être temporaire, inattendue, et concerner n'importe quel collaborateur.",
        bullets: [
          "Personne en fauteuil roulant ou avec une mobilité réduite permanente",
          "Collaborateur avec béquilles, plâtre ou entorse — descente des escaliers impossible ou dangereuse",
          "Personne avec une déficience visuelle, même partielle",
          "Salarié blessé PENDANT l'évacuation : chute dans l'escalier, entorse, coupure",
          "Personne intoxiquée par la fumée — désorientée, affaiblie, incapable de descendre seule",
          "Femme enceinte en fin de grossesse ou avec difficultés de mobilité",
          "Visiteur ou prestataire âgé ou avec une condition médicale non déclarée",
        ],
        highlight: "Principe : si une personne ne peut pas descendre les escaliers seule et en sécurité, elle va à l'EAS. C'est une procédure, pas un choix optionnel.",
      },
      {
        type: "scenario",
        title: "Cas de figure — que faire ?",
        body: "Vous évacuez le 5e étage. Un collègue est en béquilles suite à une opération — il ne peut pas descendre 5 étages. Un autre collègue vient de tomber dans l'escalier et s'est tordu la cheville. Que faites-vous ? Dans les deux cas : conduire la personne à l'EAS du palier, s'assurer qu'elle peut communiquer avec les secours, signaler sa présence et son emplacement précis au 777 (fixe) ou aux pompiers à l'extérieur. Ne jamais tenter de porter quelqu'un dans un escalier sans formation spécifique.",
        highlight: "Signaler : étage, EAS, nombre de personnes, nature de l'incapacité.",
      },
    ],
    keyPoints: [
      "EAS = Espace d'Attente Sécurisé : palier d'escalier protégé, signalé, avec communication secours. Prévu pour toute personne ne pouvant évacuer par les escaliers à l'instant T.",
      "Incapacité temporaire inclut : béquilles, blessure pendant l'évacuation, intoxication fumée, déficience visuelle — pas uniquement handicap permanent.",
      "Conduite à tenir : amener en EAS, ne pas porter sans formation, signaler position précise aux secours. Jamais l'ascenseur.",
    ],
    quiz: [
      {
        id: "q1",
