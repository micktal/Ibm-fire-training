...
const m1_hotspot: HotspotExercise = {
  type: "hotspot",
  instruction: "Identifiez tous les signes d'alerte dans cette scène de bureau IBM",
  context: "Cliquez sur chaque zone suspecte pour analyser la situation. Trouvez les 5 indices.",
  image: `${CDN}f70ab7cdd9114da8bfd5ad197221b46b?format=webp&width=800`,
  successMessage: "Excellent — vous avez identifié tous les signaux de départ de feu !",
  hotspots: [
    {
      id: "hs1", x: 13, y: 30,
      label: "Déclencheur d'alarme incendie",
      description: "Ce boîtier rouge 'FIRE — PULL DOWN' est le déclencheur manuel le plus proche. Il doit être activé dès qu'un départ de feu est confirmé.",
      type: "safe",
      detail: "Réflexe IBM : activer l'alarme AVANT de tenter d'éteindre le feu",
    },
    {
      id: "hs2", x: 62, y: 78,
      label: "Multiprise en feu",
      description: "Plusieurs câbles branchés sur la même multiprise ont provoqué une surcharge électrique. Les flammes sont déjà visibles — feu de classe B/électrique.",
      type: "danger",
      detail: "Réflexe : ne jamais utiliser d'eau — CO2 uniquement sur feu électrique",
    },
    {
      id: "hs3", x: 55, y: 38,
      label: "Colonne de fumée noire",
      description: "La fumée noire et dense indique une combustion de matériaux synthétiques (câbles, plastiques). Toxique dès les premières inhalations.",
      type: "danger",
      detail: "Réflexe : se baisser sous le niveau de fumée, protéger les voies respiratoires",
    },
    {
      id: "hs4", x: 46, y: 68,
      label: "Câbles emmêlés — risque de propagation",
      description: "Un faisceau de câbles non gainés court sur le sol vers d'autres postes. La chaleur peut se propager rapidement le long des fils.",
      type: "danger",
      detail: "Réflexe : couper l'alimentation générale du local si possible",
    },
    {
      id: "hs5", x: 82, y: 50,
      label: "Bureau et matériel non évacués",
      description: "Les ordinateurs et équipements restés allumés représentent des sources d'alimentation supplémentaires pouvant alimenter la propagation.",
      type: "info",
      detail: "Lors de l'évacuation : ne jamais revenir chercher ses affaires personnelles",
    },
  ],
};
...
const m1_branching: BranchingExercise = {
  type: "branching",
  title: "Feu ou pas feu ?",
  subtitle: "Exercice de détection rapide",
  startNode: "start",
  successMessage: "Réflexes de détection maîtrisés — vous avez pris les bonnes décisions",
  failMessage: "Certaines décisions ont aggravé la situation — revoyez les signaux d'alerte",
  nodes: {
    start: {
      id: "start",
      image: `${CDN}9cef8b4c4b544ccba1f46d55903ffdb8?format=webp&width=800`,
      situation: "Il est 14h30. Vous travaillez dans l'open space. Vous sentez une légère odeur de brûlé.",
      context: "L'alarme n'a pas sonné. Personne d'autre ne semble l'avoir remarqué.",
      urgency: "medium",
      timed: 15,
      choices: [
        {
          label: "Je me lève et cherche la source immédiatement",
          consequence: "Bonne initiative. Vous trouvez une multiprise qui fume sous un bureau. Le problème est localisé rapidement.",
          consequenceType: "ok",
          nextNode: "found_source",
          points: 10,
        },
        {
          label: "J'attends de voir si l'alarme se déclenche",
          consequence: "Erreur. L'alarme ne se déclenche que si un détecteur capte la fumée. En attendant, le feu peut se développer pendant plusieurs minutes.",
          consequenceType: "ko",
          nextNode: "waited",
          points: 0,
        },
        {
          label: "Je préviens un collègue et lui demande d'aller voir",
          consequence: "Décision partielle. Prévenir est bien, mais vous devez également agir vous-même. Votre collègue confirme une multiprise fumante.",
          consequenceType: "ok",
          nextNode: "found_source",
          points: 7,
        },
    ...
    found_source: {
      ...
      situation: "Vous trouvez une multiprise qui fume. De petites flammes commencent à lécher les câbles.",
      context: "Le feu est petit — taille d'une feuille A4. Un extincteur CO2 est à 4 mètres. La sortie est dégagée.",
      urgency: "high",
      timed: 10,
      choices: [
        {
          label: "Je décroche l'extincteur CO2 et j'attaque la base des flammes",
          consequence: "Excellente décision. Le feu est petit et électrique, le CO2 est adapté. Vous maîtrisez le départ de feu en 20 secondes.",
          consequenceType: "ok",
          nextNode: "end_success",
          points: 10,
        },
        {
          label: "Je déclenche l'alarme d'abord, puis j'évacue",
          consequence: "Bonne décision de sécurité. Pour un feu électrique sans formation préalable, évacuer et alerter est toujours acceptable.",
          consequenceType: "ok",
          nextNode: "end_success",
          points: 9,
        },
        {
          label: "Je verse de l'eau depuis la fontaine du couloir",
          consequence: "Erreur critique. L'eau sur un feu électrique provoque un court-circuit et risque d'électrocution grave.",
          consequenceType: "critical",
          nextNode: "end_fail",
          points: 0,
        },
        {
          label: "Je soufle sur les flammes pour les éteindre",
          consequence: "Erreur. Souffler apporte de l'oxygène et accélère la combustion. Le feu s'intensifie immédiatement.",
          consequenceType: "ko",
          nextNode: "end_fail",
          points: 0,
        },
    ...
    waited: {
      ...
      situation: "5 minutes se sont écoulées. L'alarme se déclenche enfin. Le feu a maintenant gagné le bureau voisin.",
      context: "La fumée est dense. La situation aurait pu être maîtrisée bien plus tôt.",
      urgency: "high",
      choices: [
        {
          label: "J'évacue immédiatement et guide mes collègues",
          consequence: "Bonne décision. Il est trop tard pour intervenir — l'évacuation est la seule option. Vous guidez vos collègues vers la sortie.",
          consequenceType: "ok",
          nextNode: "end_late",
          points: 8,
        },
        {
          label: "Je tente d'intervenir avec l'extincteur",
          consequence: "Erreur. Le feu est trop développé pour une intervention individuelle. Vous risquez votre vie. Priorité : évacuation.",
          consequenceType: "critical",
          nextNode: "end_fail",
          points: 0,
        },
    ...
    end_success: {
      id: "end_success",
      situation: "Situation maîtrisée. Le départ de feu a été éteint ou l'évacuation effectuée dans les règles.",
      context: "Votre réactivité et vos bons réflexes ont permis d'éviter une propagation.",
      urgency: "low",
      choices: [
        {
          label: "Terminer le scénario",
          consequence: "Félicitations. Vous avez adopté les bons réflexes face à un départ de feu.",
          consequenceType: "ok",
          points: 10,
        },
      ],
    ...
    end_late: {
      id: "end_late",
      situation: "Évacuation effectuée. Le bâtiment sera partiellement endommagé, mais tout le monde est en sécurité.",
      context: "Une intervention plus rapide aurait pu limiter les dégâts.",
      urgency: "low",
      choices: [
        {
          label: "Terminer le scénario",
          consequence: "Tout le monde est sauf, mais une réaction plus rapide aurait évité la propagation.",
          consequenceType: "ok",
          points: 5,
        },
      ],
    ...
    end_fail: {
      id: "end_fail",
      situation: "La situation a dégénéré suite à une mauvaise décision. C'est pourquoi la formation est essentielle.",
      context: "Ce scénario illustre les erreurs les plus courantes. Recommencez pour adopter les bons réflexes.",
      urgency: "high",
      choices: [
        {
          label: "Recommencer et faire les bons choix",
          consequence: "La formation permet d'acquérir ces réflexes avant de les avoir besoin en situation réelle.",
          consequenceType: "ok",
          points: 0,
        },
      ],
...
const m3_hotspot: HotspotExercise = {
  ...
  hotspots: [
    {
      id: "h1", x: 15, y: 55,
      label: "Porte ouverte côté feu",
      description: "Une porte laissée ouverte permet à la fumée et à la chaleur de se propager librement dans le couloir. Chaque seconde d'exposition augmente la surface touchée.",
      type: "danger",
      detail: "Une porte fermée ralentit la propagation de 20 à 30 minutes",
    },
    {
      id: "h2", x: 82, y: 40,
      label: "Déclencheur d'alarme manuel",
      description: "Le déclencheur est visible et accessible. L'activer maintenant alerterait tout le bâtiment et déclencherait l'évacuation.",
      type: "safe",
      detail: "Distance maximale recommandée : 30m entre deux déclencheurs",
    },
    {
      id: "h3", x: 50, y: 25,
      label: "Fumée en hauteur",
      description: "La fumée noire dense monte vers le plafond. Sa progression indique la direction du feu et la vitesse de propagation. L'air respirable est en bas.",
      type: "danger",
      detail: "En cas de fumée dense : se baisser et longer les murs",
    },
    {
      id: "h4", x: 65, y: 75,
      label: "Extincteur sur le mur",
      description: "Un extincteur CO2 est fixé au mur, visible et accessible. Adapté à la plupart des feux d'espaces de bureau.",
      type: "info",
      detail: "Vérifier qu'il est adapté au type de feu avant utilisation",
    },
  ],
};
