...
const m1_hotspot: HotspotExercise = {
  ...
  successMessage: "Parfait — les 3 réflexes IBM sont maîtrisés : Alarme (777) → Débrancher → Évacuer",
  successMessageEn: "Perfect — the 3 IBM reflexes are mastered: Alarm (777) → Unplug → Evacuate",
  hotspots: [
    {
      id: "hs2", x: 13, y: 30,
...
const m1_branching: BranchingExercise = {
  ...
  subtitle: "Alarme (777) · Débrancher · Évacuer",
  subtitleEn: "Alarm (777) · Unplug · Evacuate",
  startNode: "step1",
  successMessage: "Parfait — vous avez appliqué les 3 réflexes IBM dans le bon ordre : Alarme → Débrancher → Évacuer",
  successMessageEn: "Perfect — you applied the 3 IBM reflexes in the right order: Alarm → Unplug → Evacuate",
  ...
  nodes: {
    step1: {
      ...
      situation: "Réflexe 1 — Une multiprise prend feu sous un bureau. Les flammes sont visibles. Quelle est votre toute première action ?",
      situationEn: "Reflex 1 — A power strip catches fire under a desk. Flames are visible. What is your very first action?",
      ...
      choices: [
        ...
        {
          label: "Je débranche immédiatement la prise électrique",
          labelEn: "I immediately unplug the electrical socket",
          consequence: "Débrancher peut être utile, mais l'alarme doit venir en premier. Sans alerte, vos collègues ne sont pas prévenus et les secours ne sont pas mobilisés.",
          consequenceEn: "Unplugging can help, but the alarm must come first. Without alerting, your colleagues aren't warned and emergency services aren't mobilised.",
          consequenceType: "ko",
          nextNode: "step2",
          points: 4,
        },
    ...
    step2: {
      id: "step2",
      image: `${CDN}f70ab7cdd9114da8bfd5ad197221b46b?format=webp&width=800`,
      situation: "Réflexe 2 — L'alarme est déclenchée, le 777 prévenu. La prise est encore branchée. Quelle est votre deuxième action ?",
      situationEn: "Reflex 2 — Alarm triggered, 777 notified. The socket is still plugged in. What is your second action?",
      context: "Le feu est de petite taille. La prise murale est accessible et la zone est sécurisée.",
      contextEn: "The fire is small. The wall socket is accessible and the area is safe.",
      urgency: "high",
      choices: [
        {
          ...
          consequence: "Correct. Couper l'alimentation électrique élimine la source du feu. Jamais d'eau — CO2 uniquement. Ensuite, évacuez.",
          consequenceEn: "Correct. Cutting the power eliminates the fire source. Never water — CO2 only. Then evacuate.",
          consequenceType: "ok",
          nextNode: "step3",
          points: 10,
        },
...
const m4_dragdrop: DragDropExercise = {
  type: "dragdrop",
  instruction: "Pour chaque situation, glissez vers le bon extincteur",
  instructionEn: "For each situation, drag to the correct extinguisher",
  context: "Dans vos locaux IBM, deux extincteurs essentiels : CO2 pour l'électrique, eau pulvérisée pour les solides.",
  contextEn: "In your IBM premises, two essential extinguishers: CO2 for electrical, water mist for solids.",
  successMessage: "Parfait — vous savez choisir le bon extincteur en situation réelle IBM !",
  successMessageEn: "Perfect — you know how to choose the right extinguisher in a real IBM situation!",
  items: [
    ...
    { id: "i9", label: "Poubelle / corbeille", labelEn: "Wastepaper basket", sublabel: "Papier, carton, plastique", sublabelEn: "Paper, cardboard, plastic", icon: "FileText", correctZone: "A" },
  ],
  zones: [
    {
      id: "A",
      label: "Eau pulvérisée",
      labelEn: "Water mist",
      sublabel: "Feux de solides : papier, plastique, mobilier",
      sublabelEn: "Solid fires: paper, plastic, furniture",
      description: "Papier, plastique, bois, tissu, mobilier. L'eau pulvérisée refroidit le combustible. Jamais sur de l'électrique.",
      descriptionEn: "Paper, plastic, wood, fabric, furniture. Water mist cools the fuel. Never on electrical equipment.",
      color: "#b45309",
      bgColor: "rgba(180,83,9,0.06)",
      borderColor: "rgba(180,83,9,0.25)",
    },
    {
      id: "elec",
      label: "CO2 uniquement",
      labelEn: "CO2 only",
      sublabel: "Feux électriques : serveurs, câbles, chargeurs",
      sublabelEn: "Electrical fires: servers, cables, chargers",
      description: "L'eau conduit l'électricité : risque d'électrocution immédiat. CO2 uniquement sur tout matériel sous tension.",
      descriptionEn: "Water conducts electricity: immediate electrocution risk. CO2 only on live electrical equipment.",
      color: "#0043ce",
      bgColor: "rgba(0,67,206,0.06)",
      borderColor: "rgba(0,67,206,0.25)",
    },
...
const m5_branching: BranchingExercise = {
  ...
  nodes: {
    start: {
      ...
      situation: "Feu de câbles sur un bureau. Vous avez un extincteur CO2. Le feu est très petit — tout début, encore contenu. La sortie est à 4 mètres derrière vous.",
      situationEn: "Cable fire on a desk. You have a CO2 extinguisher. The fire is very small — just starting, still contained. The exit is 4 metres behind you.",
      urgency: "high",
      timed: 25,
      choices: [
        {
...
const ch2m6_hotspot: HotspotExercise = {
  ...
  hotspots: [
    ...
    },
    {
      ...
      description: "Si l'escalier est impraticable (fumée, feu), l'EAS est la zone de refuge. Porte coupe-feu, instructions affichées pour communiquer avec les secours, signalisation spécifique.",
      descriptionEn: "If the staircase is impassable (smoke, fire), the EWS is the refuge area. Fire door, posted instructions to communicate with emergency services, specific signage.",
      type: "info",
...
const ch2m1_binary: GridQuizExercise = {
  ...
  cells: [
    ...
    {
      statement: "Un EAS (Espace d'Attente Sécurisé) est uniquement destiné aux personnes en fauteuil roulant.",
      statementEn: "An EWS (Emergency Waiting Space) is only intended for wheelchair users.",
      correct: "false",
      explanation: "FAUX. L'EAS est destiné à toute personne ne pouvant pas évacuer par les escaliers à l'instant T : béquilles, blessure pendant l'évacuation, intoxication fumée, déficience visuelle, grossesse. L'incapacité peut être temporaire.",
      explanationEn: "FALSE. The EWS is for any person unable to evacuate via stairs at that moment: crutches, injury during evacuation, smoke intoxication, visual impairment, pregnancy. The incapacity can be temporary.",
    },
    {
      statement: "En cas de présence en EAS, il faut tenter de descendre les escaliers soi-même pour ne pas retarder les secours.",
      statementEn: "If waiting in an EWS, you should try to descend the stairs yourself to avoid delaying emergency services.",
      correct: "false",
      explanation: "FAUX. Rester en EAS et signaler sa position est la bonne procédure. Tenter de descendre seul dans des conditions dégradées aggrave le risque. Les secours sont formés et équipés pour les EAS.",
      explanationEn: "FALSE. Staying in the EWS and reporting your position is the correct procedure. Attempting to descend alone in degraded conditions increases the risk. Emergency services are trained and equipped for EWS interventions.",
    },
    {
      statement: "Un collaborateur intoxiqué par la fumée peut utiliser un EAS même s'il est habituellement valide.",
      statementEn: "An employee intoxicated by smoke can use an EWS even if they are normally able-bodied.",
      correct: "true",
      explanation: "VRAI. L'EAS est prévu pour toute incapacité temporaire, y compris l'intoxication par la fumée qui peut désorieneter ou affaiblir une personne valide. C'est une procédure de sécurité, pas une mesure réservée au handicap.",
      explanationEn: "TRUE. The EWS is designed for any temporary incapacity, including smoke intoxication which can disorient or weaken an able-bodied person. It is a safety procedure, not a measure reserved for disability.",
    },
  ],
};
...
const ch2m3_fillblank: FillBlankExercise = {
  ...
  sentences: [
    ...
    { before: "Signalez les zones vérifiées au", beforeEn: "Report checked areas to the", answer: "responsable évacuation", answerEn: "evacuation warden", acceptableAnswers: ["responsable de l'évacuation", "responsable evacuation", "chef évacuation", "chef evacuation", "responsable", "responsable d'évacuation", "responsable d evacuation", "responsable d'evacuation", "responsable de l evacuation", "responsable de l'evacuation", "responsable évac", "chef d'évacuation", "chef evacuation", "le responsable", "responsable incendie", "agent évacuation", "agent evacuation"], acceptableAnswersEn: ["warden", "floor warden", "fire warden", "evacuation officer", "marshal", "evacuation marshal", "safety warden", "the warden"], after: "au point de rassemblement.", afterEn: "at the assembly point.", hint: "personne en charge", hintEn: "person in charge" },
    { before: "Ne", beforeEn: "Never", answer: "jamais revenir", answerEn: "go back", acceptableAnswers: ["ne jamais revenir", "pas revenir", "ne pas revenir", "jamais retourner", "ne jamais retourner", "jamais", "ne jamais", "jamais rentrer", "ne jamais rentrer", "pas retourner", "ne pas retourner", "jamais y retourner", "ne jamais y retourner", "jamais y revenir"], acceptableAnswersEn: ["return", "come back", "go back in", "re-enter", "never", "go back", "return inside"], after: "chercher ses affaires une fois l'évacuation lancée.", afterEn: "to collect belongings once evacuation has started.", hint: "interdiction absolue", hintEn: "absolute rule" },
  ],
};
...
const m4_matching: MatchExercise = {
  type: "matching",
  title: "CO2 ou eau pulvérisée — quelle situation ?",
  titleEn: "CO2 or water mist — which situation?",
  subtitle: "Associez chaque situation IBM au bon extincteur",
  subtitleEn: "Match each IBM situation to the correct extinguisher",
  successMessage: "Parfait — vous choisissez le bon extincteur en 2 secondes !",
  successMessageEn: "Perfect — you choose the right extinguisher in 2 seconds!",
  pairs: [
    { left: "Rack serveur en feu (sous tension)", leftEn: "Server rack on fire (live power)", right: "CO2 uniquement", rightEn: "CO2 only" },
    { left: "Corbeille de papier en feu", leftEn: "Paper bin on fire", right: "Eau pulvérisée", rightEn: "Water mist" },
    { left: "Chargeur de laptop qui s'embrase", leftEn: "Laptop charger catches fire", right: "CO2 uniquement", rightEn: "CO2 only" },
    { left: "Mobilier / plastique en feu", leftEn: "Furniture / plastic on fire", right: "Eau pulvérisée", rightEn: "Water mist" },
    { left: "Câbles électriques qui brûlent", leftEn: "Burning electrical cables", right: "CO2 uniquement", rightEn: "CO2 only" },
  ],
};
...
const m4_tipflip: TipFlipExercise = {
  ...
  cards: [
    {
      icon: "Flame", accent: "flame", stat: "2",
      label: "Extincteurs à connaître en IBM", labelEn: "Extinguishers to know at IBM",
      category: "chiffre",
      tipTitle: "CO2 ou eau pulvérisée", tipTitleEn: "CO2 or water mist",
      tip: "En environnement IBM, deux extincteurs essentiels. CO2 (étiquette noire) pour tout matériel électrique sous tension. Eau pulvérisée (étiquette rouge) pour les solides : papier, plastique, mobilier. Utiliser le mauvais agent peut être fatal.",
      tipEn: "In an IBM environment, two essential extinguishers. CO2 (black label) for all live electrical equipment. Water mist (red label) for solids: paper, plastic, furniture. Using the wrong agent can be fatal.",
    },
    {
    ...
    },
    {
      ...
      tip: "Cette règle s'applique au CO₂ comme à l'eau pulvérisée : 2-3 mètres du foyer. Le CO₂ sort à -78°C — trop proche = brûlure par le froid. Trop loin = perte d'efficacité. 2-3 mètres est la distance de sécurité valable pour les deux agents.",
      tipEn: "This rule applies to both CO₂ and water mist: 2-3 metres from the fire. CO₂ is discharged at -78°C — too close = cold burns. Too far = loss of effectiveness. 2-3 metres is the safety distance for both agents.",
    },
  ],
};
...
const m6_tipflip: TipFlipExercise = {
  ...
  cards: [
    ...
    },
    {
      ...
      tip: "Feu naissant de très petite taille (équivalent corbeille à papier), extincteur adapté à portée, sortie dégagée dans le dos. L'extincteur n'est pas un outil de lutte contre un incendie déclaré — uniquement le tout début du feu. Si UN seul critère manque : évacuez.",
      tipEn: "Very small initial fire only (wastepaper-bin sized), suitable extinguisher within reach, clear exit behind you. A fire extinguisher is not a tool for fighting a developed fire — only a very small, just-started one. If ONE condition is missing: evacuate.",
    },
    {
...
const m2_spinwheel: SpinWheelExercise = {
  ...
  items: [
    ...
    },
    {
      ...
      correctKey: "D",
      explanation: "La classe E désigne les feux sur équipements électriques sous tension. N'utilisez jamais d'eau — uniquement CO2.",
      explanationEn: "Class E designates fires on live electrical equipment. Never use water — CO2 only.",
    },
    {
      label: "RÉFLEXE",
      labelEn: "REFLEX",
...
const m5_gridquiz: GridQuizExercise = {
  ...
  cells: [
    ...
    {
      statement: "L'eau pulvérisée peut être utilisée sur un feu électrique (serveur, câble) en cas d'urgence.",
      statementEn: "Water mist can be used on an electrical fire (server, cable) in an emergency.",
      correct: "false",
      explanation: "FAUX. L'eau conduit l'électricité — risque d'électrocution fatal. Sur tout matériel électrique sous tension, seul le CO2 est autorisé. Jamais d'eau, même en urgence.",
      explanationEn: "FALSE. Water conducts electricity — fatal electrocution risk. On any live electrical equipment, only CO2 is permitted. Never water, even in an emergency.",
    },
    {
