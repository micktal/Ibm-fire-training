  ...
  hotspots: [
    {
      ...
      descriptionEn: "The safety pin prevents accidental activation. Pull it with a sharp movement. This is always the FIRST step.",
      type: "info",
    ...
    },
    {
      ...
      descriptionEn: "Press firmly on the trigger handle. Maintain continuous pressure for a steady jet.",
      type: "info",
    ...
    },
    {
      ...
      descriptionEn: "Point the nozzle or hose at the BASE of the flames — never upward. The base is where the fuel is.",
      type: "info",
      detail: "Distance optimale : 2 à 3 mètres du foyer",
      detailEn: "Optimal distance: 2 to 3 metres from the fire",
    },
    {
      id: "h4", x: 18, y: 78,
      label: "S — Sweep (Balayer)",
      labelEn: "S — Sweep (Sweep side to side)",
      description: "Balayez lentement de gauche à droite, toujours en visant la base. Continuez jusqu'à extinction complète.",
      descriptionEn: "Sweep slowly from left to right, always targeting the base. Continue until fully extinguished.",
      type: "safe",
      detail: "Si le feu ne recule pas en 30s : reculez et évacuez",
      detailEn: "If the fire doesn't retreat in 30s: retreat and evacuate",
    },
  ],
};
