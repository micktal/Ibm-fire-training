...
const m1_hotspot: HotspotExercise = {
  ...
  hotspots: [
    {
      id: "hs1", x: 22, y: 68,
      label: "Multiprise surchargée",
      description: "Cette multiprise présente plusieurs câbles emmêlés et une légère fumée à la base. Signal typique d'un court-circuit imminent.",
      type: "danger",
      detail: "Réflexe : débrancher immédiatement et alerter",
    },
    {
      id: "hs2", x: 58, y: 35,
      label: "Fumée légère au plafond",
      description: "Une légère trainée bleutée se forme en hauteur. La fumée monte — signe qu'une combustion est en cours quelque part dans la pièce.",
      type: "danger",
      detail: "Réflexe : déclencher l'alarme sans attendre confirmation",
    },
    {
      id: "hs3", x: 78, y: 55,
      label: "Ordinateur chaud anormal",
      description: "L'écran affiche des artefacts et l'unité centrale dégage une chaleur excessive. Un composant électronique est en train de surchauffer.",
      type: "danger",
      detail: "Réflexe : éteindre et débrancher l'alimentation",
    },
    {
      id: "hs4", x: 40, y: 78,
      label: "Extincteur CO2 accessible",
      description: "Extincteur CO2 présent et accessible à moins de 3 mètres. Adapté aux feux électriques — vérifié trimestriellement.",
      type: "safe",
      detail: "La porte de sortie est également visible et dégagée",
    },
    {
      id: "hs5", x: 12, y: 45,
      label: "Odeur de plastique brûlé",
      description: "Des fils d'isolation surchauffée dégagent une odeur acre de plastique fondu. Invisible à l'œil nu mais détectable immédiatement.",
      type: "info",
      detail: "Ce signal précède souvent l'apparition de la flamme de 2 à 5 minutes",
    },
  ],
};
