  ...
  // ── ch1-m1 : Détecter un départ de feu ──────────────────────
  {
    ...
    choices: [
      ...
      },
      {
        ...
        labelEn: "Call 22 22 and report the situation",
        correct: true,
        feedback: "Correct. Alerter le 22 22 en priorité avec votre localisation exacte. La sécurité IBM prend le relais.",
        feedbackEn: "Correct. Alert 22 22 first with your exact location. IBM Security takes over from there.",
      },
      {
        key: "C",
  ...
  // ── ch1-m5 : Utiliser un extincteur ─────────────────────────
  {
    ...
    choices: [
      ...
      },
      {
        ...
        feedbackEn: "If the fire is still small and an exit is behind you, intervening is possible. But call 22 22 first.",
      },
    ],
  },
  ...
  // ── ch2-m6 : Escaliers ou espace sécurisé ───────────────────
  {
    ...
    choices: [
      ...
      },
      {
        ...
        labelEn: "Head to the safe waiting area and call 22 22",
        correct: true,
      ...
      },
      {
        ...
        feedbackEn: "Never leave the person alone. Stay with them in the safe waiting area and call 22 22.",
      },
    ],
  },
];
