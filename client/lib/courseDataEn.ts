...
export const MODULES_EN: CourseModule[] = [
...

  {
    ...
    preTest: [
      ...
      { question: "If a colleague cannot evacuate via the stairs, they must:", choices: [{ key: "A", label: "Wait in their office for help to arrive" }, { key: "B", label: "Call 18 themselves from their mobile" }, { key: "C", label: "Go to the EWS on the nearest landing and report their location to emergency services" }], correctKey: "C" },
    ],
    content: [
...

  {
    ...
    preTest: [
      ...
      { question: "A colleague uses a wheelchair. The stairwell is the only exit. What do you do?", choices: [{ key: "A", label: "Carry them down the stairs" }, { key: "B", label: "Take them to the EWS on the nearest landing and follow the posted instructions" }, { key: "C", label: "Leave them — they'll be found later" }], correctKey: "B" },
    ],
    content: [
